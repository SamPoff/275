...
int main()  {
    ...
    for (int i = 0; i < 10; i++)  {
        ...
        account[i].BankAccountMaker(firstAccount);
        firstAccount++;
        ...
        if (firstMenuSelect == 1)  {
            ...
            while (com2)  {
                ...
                //Accrue Interest
                    ...
                    cout << "\nYour new balance after 5 years is: " << balance + balanceAdd << endl;
...
double accrue(int accountSelect, double interest, int years, BankAccount account[])  {
    ...
    double balanceAdd = balance * (1 + (interest * years));
